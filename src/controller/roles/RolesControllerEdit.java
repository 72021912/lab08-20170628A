...
public class RolesControllerEdit extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getParameter("action").equals("guardar")) {
			Role nuevo = pm.getObjectById(Role.class, Long.parseLong(request.getParameter("cambiarID")));
			...
			Role cambio = pm.getObjectById(Role.class, Long.parseLong(request.getParameter("cambiarID")));

			request.setAttribute("editRole", cambio);
